...
const promoBanners = [
  {
    id: 1,
    image: "/images/nutren-junior-head-banner-19082025.avif",
  ...
  {
    id: 2,
    image: "/images/Screenshot 2025-10-25 203248.png",
    title: "Sweet Treats diskon s.d. 30%",
    link: "/promo/sweet-treats",
    cta: "klik di sini",
  },
  {
    id: 3,
    image: "/images/Screenshot 2025-10-25 202648.png",
  ...
  {
    id: 4,
    image: "/images/Screenshot 2025-10-25 203225.png",
    title: "Belanja hemat bulanan",
    ...
    <>
      <header className="relative flex items-center bg-[#187247] px-8 py-3 text-white">
        ...
        <div className="flex items-center gap-10 flex-1">
          ...
          {/* Promo - navigates to cart when clicked */}
          <Link href="/cart" prefetch={false} className="flex items-center gap-15 font-semibold text-white ml-6" aria-label="Promo - buka keranjang">
            <span>Promo</span>
            <Image src="/img/icon-promo.png" alt="Promo" className="h-5" width={20} height={20} />
          </Link>
        </div>
                        ...
                        <div className="flex w-full gap-4 overflow-x-auto pb-2">
                          {mockProducts.slice(0, 4).map((p) => (
                            <div key={p.id} className="min-w-[128px] rounded-2xl border border-[#E5E7EB] bg-white/90 p-3 shadow-sm">
                              <Image src={p.image} alt={p.name} className="h-24 w-full rounded-xl object-cover" width={160} height={96} />
                    ...
                    {mockProducts.map((p) => (
                      <div key={p.id} className="min-w-40">
                        <div className="rounded-lg bg-white p-3 shadow-sm">
                          <Image src={p.image} alt={p.name} className="h-28 w-full object-cover rounded" width={160} height={112} />

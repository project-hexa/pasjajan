              ...
              <CardContent>
                <div className="flex flex-col gap-2 items-center">
                  <p>
                    ...
                    Sit optio unde earum, ducimus corporis minima numquam odio
                    dolores praesentium ipsa explicabo corrupti illum facilis,
                    tenetur maiores officia porro. At non nulla asperiores
                    fugiat repellendus sunt nam dolores nesciunt, assumenda,
                    nihil ullam saepe, quam est! Ea id saepe iusto modi quasi,
                    nobis nemo iste explicabo nulla molestiae ab totam itaque
                    laboriosam recusandae? Dicta aliquam dolorum itaque velit
                    assumenda deleniti nesciunt, beatae modi praesentium
                    quibusdam rerum, dignissimos reiciendis? Fugit perferendis
                    nisi animi nostrum libero tempora, quo quos quaerat rerum
                    suscipit numquam sit accusantium unde deserunt fugiat,
                    minima quidem excepturi quae! Reprehenderit, magni!
                  </p>
                </div>
              </CardContent>
            </Card>
